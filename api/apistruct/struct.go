...
type FullNodeStruct struct {
	...
	Internal struct {
		...
		StateChangedActors func(p0 context.Context, p1 cid.Cid, p2 cid.Cid) (map[string]types.Actor, map[string]types.Actor, map[string]types.Actor, error) `perm:"read"`
...
func (s *FullNodeStruct) StateChangedActors(p0 context.Context, p1 cid.Cid, p2 cid.Cid) (map[string]types.Actor, map[string]types.Actor, map[string]types.Actor, error) {
